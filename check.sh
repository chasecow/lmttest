...
clear;
echo -e "流媒体解锁测试 Streaming media_Test" && echo -e "流媒体解锁测试 Streaming media_Test" > ${LOG_FILE};
echo -e "${Font_Purple}@chasecow https://t.me/chasecow${Font_Suffix}" && echo -e "@chasecow https://t.me/chasecow" >> ${LOG_FILE};
